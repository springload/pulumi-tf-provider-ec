...
namespace Pulumi.Ec
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ec.version.txt");
    ...
    internal sealed class EcResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public EcResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
