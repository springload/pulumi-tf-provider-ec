...
First, clone this repo with the name of the desired provider in place of `ec`:

```
git clone https://github.com/pulumi/pulumi-tf-provider-boilerplate pulumi-ec
```

Second, replace references to `ec` with the name of your provider:
